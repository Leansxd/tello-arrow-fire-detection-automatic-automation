    ...
    def logic_loop(self):
        while self.running:
            ...
            if box is not None:
                ...
                is_aligned_xy = abs(err_x) < self.cfg.YATAY_HASSASIYET and abs(err_y) < self.cfg.DIKEY_HASSASIYET
                ...
                if self.state == "WAITING":
                    ...
                    if is_aligned:
                        ...
                        if not SIMULATION and (10 <= dist_cm < 300):
                            ...
                            if bw < IDEAL_BW_MIN: fb = 15
                            elif bw > IDEAL_BW_MAX: fb = -15
    ...
    def execute_command(self, cmd):
        ...
        with self.cmd_lock:
            ...
            if cmd_lower in self.gorevler:
                ...
                print(f"[UYARI] Lütfen @sistem.hedefte('{cmd}') ile bir fonksiyon tanımlayın.")
